          ...
          <Link to='#' className="smallStory">
            ...
            <div className="smallStoryInfo">
              ...
              <div className="readStory">
                <a href="https://www.instagram.com/reel/CkvDPepjYZ6/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="blank">VİDEONUN DEVAMI</a>
                <a href=""><img src="/images/arrow-right-w.png" /></a>
              </div>
            </div>
          </Link>
          <Link to='#' className="smallStory">
